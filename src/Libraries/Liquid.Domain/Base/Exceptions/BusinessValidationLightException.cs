...
namespace Liquid.Domain
{
    ...
    /// </summary>
    [Serializable]
    public class BusinessValidationLightException : LightException
    {
        /// <summary>
        /// The list of input errors issued
        /// </summary>
        ...
        public BusinessValidationLightException(Dictionary<string, object[]> inputErrors) : base()
        {
        ...
        protected BusinessValidationLightException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
}
