...
#pragma warning disable CA1000 // Do not declare static members on generic types
    ...
    public class LightExpression<T>
    {
        ...
        /// <returns></returns>
        public static LightExpression<T> New(Expression<Func<T, bool>> expr = null)
        {
            return new(expr);
        }
        ...
        /// <summary>
        /// Determines if the filter is started.
        /// </summary>
        ...
        {
            return right is null ? null : new LightExpression<T>(right);
        }
